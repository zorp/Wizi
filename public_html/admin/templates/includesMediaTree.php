...
<script language="javascript">
	...
	function selectNode( id, nodeName, nodeFormat )
	{
		document.tree.choosenIcon.value = id;
		document.tree.choosenIconName.value = nodeName;
		document.tree.choosenIconFormat.value = nodeFormat;
		document.tree.submit();
	}
</script>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="selectNode(<?=$nodes[$i]["id"]?>,'<?=addslashes($nodes[$i]["name"])?>','<?=$nodes[$i]["format"]?>');return false;" title="Select" class="nodeName"><img src="../mediatree/graphics/file_icons/<?=$format?>.gif" alt="Select" border="0"/></a>
                                    </td>
                                    ...
                                    <?//==================ITEM NAME CELL============================?>
                                    <td>
                                        <a href="#" onclick="selectNode(<?=$nodes[$i]["id"]?>,'<?=addslashes($nodes[$i]["name"])?>','<?=$nodes[$i]["format"]?>');return false;" class="nodeName"><?=$nodes[$i]["name"] ?></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
