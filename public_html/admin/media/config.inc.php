...
*/
$IMConfig['base_dir'] = $_SERVER["DOCUMENT_ROOT"].$dba->rootpath."/media/";
//$IMConfig['base_dir'] = '/home/dev/docs/media/';
...
*/
$IMConfig['base_url'] = "http://".$_SERVER["HTTP_HOST"].$dba->rootpath."media/";
//$IMConfig['base_url'] = 'http://dev.execube.facility.dir.dk/media/';
