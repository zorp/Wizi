...
// Stuff to decide wich image formats that can be saved to. We only want to show same format as orginal image
$temp = explode(".",$_GET["imgsave"]);
$imgFormat = $temp[1];
$showJpg = false;
$showGif = false;
$showPng = false;
if ($imgFormat == "jpg" || $imgFormat == "jpeg") $showJpg = true;
if ($imgFormat == "gif") $showGif = true;
if ($imgFormat == "png") $showPng = true;
?>
...
<body>
<div id="indicator">
<img src="img/spacer.gif" id="indicator_image" height="20" width="20" alt="" /></div>
<div id="tools">
	<div id="tools_crop" style="display:none;">
		<div id="tool_inputs">
			...
			<img src="img/div.gif" height="30" width="2" class="div" alt="|" />		</div>	
		<a href="javascript: editor.doSubmit('crop');" class="buttons" title="OK"><img src="img/btn_ok.gif" height="30" width="30" alt="OK" /></a>
		<a href="javascript: editor.reset();" class="buttons" title="Cancel"><img src="img/btn_cancel.gif" height="30" width="30" alt="Cancel" /></a>	</div>	
	<div id="tools_scale" style="display:none;">
		...
		<a href="javascript: editor.reset();" class="buttons" title="Cancle"><img src="img/btn_cancel.gif" height="30" width="30" alt="Cancel" /></a>	</div>	
	...
	<div id="tools_save" style="display:none;">
		<div id="tool_inputs">
			...
			<!--<input type="text" id="save_filename" value="<? echo $editor->getDefaultSaveFile();?>"/>-->
			<input type="text" id="save_filename" value="<? echo $_GET["imgsave"];?>" readonly="true"/>
            ...
            <option value="png">PNG</option>
						<? endif ?>
			<? if($editor->isGDGIFAble() != -1 && $showGif) { ?>
...
<a href="javascript:self.close();" id="icon_close" title="Close"><img src="img/close.gif" height="20" width="20" alt="Save" /><span>Close</span></a></div>
<div id="contents">
<iframe src="editorFrame.php?img=<? if(isset($_GET["img"])) echo rawurlencode($_GET["img"]); ?>&id=<?=$_GET["id"]?>" name="editor" id="editor"  scrolling="auto" title="Image Editor" frameborder="0"></iframe>
</div>
<div id="bottom"></div>
</body>
</html>
