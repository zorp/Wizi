...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
	...
	<tr class="color1">
		<td width="10"><img src="../graphics/transp.gif" width="10" height="10"></td>
		<td style="padding-bottom:15px;" width="620" bgcolor="#FFFFFF">
			<?php
	...
	<tr>
		...
		<td style="padding-bottom:10px;" align="right">
			...
			<input type="button" name="savecontent" value="Save for Online" class="knapgreen" style="position:relative;width:125px;" onclick="updateAction('savecontent');">
		</td>
		<td>&nbsp;</td>
	</tr>
</table>
